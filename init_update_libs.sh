...
wget -O- ftp://ftp.simplesystems.org/pub/libpng/png/src/libpng16/libpng-1.6.29.tar.xz | tar xJ || exit 1
wget -O- http://downloads.sourceforge.net/project/expat/expat/2.2.1/expat-2.2.1.tar.bz2 | tar xz || exit 1
